...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <a class="navbar-brand mr-4" href="/dashboard">
        <img width="40" class="mr-1" src="https://lh3.googleusercontent.com/fJHhsE6XmKrR26RPgYiww59GJqIzSFn00yXKcdMNHxHYvZFyD7q6ARa0oVbBqoxBCA=s300" alt="logo">
        Diablo builds
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/builds">Mes builds</a>
            </li>
